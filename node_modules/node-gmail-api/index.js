...
var Gmail = function (key, gmailUsername) {
  if (!key) {
...
var retrieveCount = function (key, q, endpoint, opts, next, gmailUsername) {
  request({
    url: api + '/gmail/v1/users/'+gmailUsername+'%40gmail.com/'+endpoint,
    json: true,
...
var retrieve = function (key, q, endpoint, opts, gmailUsername) {
  ...
  request({
    ...
    var messages = body[endpoint].map(function (m) {
      return {
        ...
        body: 'GET ' + api + '/gmail/v1/users/'+gmailUsername+'%40gmail.com/' + endpoint + '/' + m.id + '\n'
      }
    })
...
Gmail.prototype.messages = function (q, opts) {
  return retrieve(this.key, q, 'messages', opts, this.gmailUsername)
}
...
Gmail.prototype.estimatedThreads = function (q, opts, next) {
  ...
  return retrieveCount(this.key, q, 'threads', opts, next, this.gmailUsername)
}

Gmail.prototype.threads = function (q, opts) {
  return retrieve(this.key, q, 'threads', opts, this.gmailUsername)
}
